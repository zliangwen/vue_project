<template>
  ...
  >
    <div class="el-progress-bar" v-if="type === 'line'" style="width:85%;">
      <div class="el-progress-bar__outer" :style="{height: strokeWidth + 'px'}" style="background:#cfcfcf;border-radius:4px;">
        <div class="el-progress-bar__inner" :style="barStyle" style="background:#f8563f;height:6px;border-radius:4px;">
    ...
    <div
      ...
      style="position:absolute;top:8px;right:0;color:#999;"
    >
